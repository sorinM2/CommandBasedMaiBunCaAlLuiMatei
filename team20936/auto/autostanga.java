...
import org.firstinspires.ftc.teamcode.team20936.auto.autoCommands.BasicCommands.SetLatchPos;
...
import org.firstinspires.ftc.teamcode.team20936.teleop.commands.setArmRevPos;
    ...
    public void run() {
        if (!isFinisheed) {
            CommandScheduler.getInstance().schedule(new SequentialCommandGroup(
                   ...
                   CommandGroups.TransferConeGroup(8, 48, -45, 1010),
                    new GotoLinearHeading(-5.5, 53, 0),
                    CommandGroups.CatchConeGroup(-364),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    CommandGroups.TransferConeGroup(8, 50,  -48),

                    new GotoLinearHeading(-5.5, 53.5, 0),
                    CommandGroups.CatchConeGroup(-384),
                    new SorinMakesBetterWaitCommands(400),
                    CommandGroups.DepositGroup(),
                    CommandGroups.TransferConeGroup(8, 50,  -48),

                    new GotoLinearHeading(-5.3, 53.5, -1),
